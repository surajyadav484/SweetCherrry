...
class SweetCherryServiceImplTest {
	...
	void testFindUserByUserIdShouldReturnUserObject() throws InvalidIdException {
		...
		userDetails.setEmail("dummydataa123@gmail.com");
		userDetails.setFirstName("Dummy");
		userDetails.setLastName("Data");
	...
	void testregisterCustomerShouldReturnUserDetailsObject() throws UserNameAndPasswordDoNotMatchRegularExpression {
		...
		userDetails.setEmail("dummydataaa12@gmail.com");
		userDetails.setFirstName("Dummy");
		userDetails.setLastName("Data");
	...
	@Test
	void testLoginShouldReturnLoginSuccessfulAsUser()
			throws NoSuchUserExists, UserNameAndPasswordDoNotMatchRegularExpression {

		UserDetails userDetails = new UserDetails();
		userDetails.setUserId(1);
		userDetails.setEmail("Dukkke@gmail.com");
	...
	@Test
	void LoginShouldThrowNoSuchUserExistsForAdmin() {
	...
	@Test
	void testLoginShouldReturnLoginSuccessfulAsAdmin()
			throws NoSuchUserExists, UserNameAndPasswordDoNotMatchRegularExpression {

		UserDetails userDetails = new UserDetails();

		userDetails.setEmail("KetanMishraaaa@gmail.com");
		userDetails.setPassword("KetanMishra@123");
		userDetails.setFirstName("Dummy");
		userDetails.setLastName("Data");
	...
	@Test
	void LoginShouldThrowNoSuchUserExists() {
		assertThrows(NoSuchUserExists.class, () -> {
	...
	void UpdatePasswordShouldReturnUpdatedPassword() throws UserNameAndPasswordDoNotMatchRegularExpression {
		...
		userDetails.setEmail("KetanMishrraarraa@gmail.com");
		userDetails.setPassword("KetanM@1234");
	...
	void testFindCupcakeByIdShouldReturnCupcakeDetails() throws NoSuchCupcakeExists {
		...
		cupcakeService.addCupcakeCategory(category);
		CupcakeDetails cupcakeDetails = new CupcakeDetails("Carrot Cupcake",
				"The cake is very moist and the icing is delicious. It's not too sweet and not greasy.", 50, 0,
				category);
	...
	@Test
	void testModifyCupCakeRatingShouldReturnUpdatedCupcakeDetails() throws NoSuchCupcakeExists {
		CupcakeCategory category = new CupcakeCategory(101, "Premium Cupcakes");
		cupcakeService.addCupcakeCategory(category);
		CupcakeDetails cupcake = new CupcakeDetails(504, "Choco lava", "Cupcake filled wwith chocolate", 60, 1,
				category);
	...
	void testShowOrderDetailsByUserIdShouldReturnOrederDetails() throws NoSuchOrderExists {
		...
		assertEquals(expected.size() , actual.size()); // checking for equality of size of both list
